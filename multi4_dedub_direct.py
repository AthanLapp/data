...
def mainz3(data1,lencol,linestart,linestop,end):
	col = 0
	col2 = 0
	sim = 0
	sims = 0
			...
			for col in range(1,lencol-1):
				...
				if (sim>80):
					...
					if sims >60 :
						...
						fout2.write(str(sims)+"\n")
	fout2.close()
	print("--- function 3 took %s seconds ---" % (time.time() - start_time))

def mainz4(data1,lencol,linestart,linestop,end):
	col = 0
	col2 = 0
	sim = 0
	sims = 0
			...
			for col in range(1,lencol-1):
				...
				if (sim>80):
					...
					if sims >60 :
						...
						fout2.write(str(sims)+"\n")
	fout2.close()
	print("--- function 4 took %s seconds ---" % (time.time() - start_time))
