...
def main():	
	...
	j = 0
	i=0
	p1 = Process(target = mainz1, args=(data1,len(columns1),0,4400,20000))
	p2 = Process(target = mainz2, args=(data1,len(columns1),4400,20000,20000))
	p1.start()
	p2.start()
	p1.join()
	p2.join()
